...
import com.personalblog.ragbackend.rag.util.FileTypeDetector;
...
public class S3FileStorageService implements FileStorageService {
    ...
    @SneakyThrows
    private StoredFileDTO streamUploadToS3(String bucketName, InputStream inputStream, long size,
                                           String originalFilename, String detectedContentType) {
        String s3Key = generateS3Key(originalFilename);
